...
int Insert(Hashtable &ht, Hocsinh x)
{
    ...
    newNode->data.Maso = x.Maso;
    newNode->data.Hoten = x.Hoten;
    newNode->data.Namsinh = x.Namsinh;
    newNode->data.Gioitinh = x.Gioitinh;
    newNode->data.TBK = x.TBK;
    newNode->next = NULL;

    if (ht.table[i].head == NULL)
        ht.table[i].head = ht.table[i].tail = newNode;
    else
    {
        ht.table[i].tail->next = newNode;
        ht.table[i].tail = newNode;
    }
